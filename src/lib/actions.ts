...
// export async function deleteSportsEvent(eventId: number): Promise<SportsEvents> {
//   try {
...
//   homeScore,
//   awayScore,
// }: { predictionId: number } & Omit<CreateSportsPredictionParams, "userId" | "sportsEventId">): Promise<SportsPredictions> {
//   try {
...
// export async function deleteSportsPrediction(predictionId: number): Promise<SportsPredictions> {
//   try {
